...
public class unos_biljaka extends JDialog {
	...
	public unos_biljaka() {
		...
		lblNewLabel_2_1.setLabelFor(textField_3);
		...
		okButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (naziv.isEmpty() || vrsta.isEmpty() || opis.isEmpty() || cijenaStr.isEmpty()) {
					JOptionPane.showMessageDialog(null, "Morate popuniti sva polja!", "Upozorenje", JOptionPane.WARNING_MESSAGE);
					return;
				}

				// Provjera je li cijena valjani decimalni broj
				double cijena;
				try {
				...
				try {
					...
					String sql = "INSERT INTO Biljka (nazivBiljke, vrstaBiljke, opisBiljke, cijenaBiljke) VALUES (?, ?, ?, ?)";
