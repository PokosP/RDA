...
public class kosarica {
	...
	private void initialize() {
		frmKoarice = new JFrame("Stavka košarice");
		frmKoarice.setTitle("Košarice");
		...
		// Donji panel: gumbi "Spremi" i "OK" jedan do drugoga
		...
		// Event: klik na OK (zatvara prozor)
		okButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				frmKoarice.dispose(); // Zatvori prozor
			}
		});
