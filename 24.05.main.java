...
public class main {
	...
	private void initialize() {
		...
		frmPoetna.setBounds(100, 100, 377, 435);
		...
		btnNewButton_2.setBounds(21, 208, 146, 60);
		...
		btnNewButton_2_1_1.setBounds(189, 115, 146, 60);
		...
		btnNewButton_2_2.setBounds(189, 22, 146, 60);
		frmPoetna.getContentPane().add(btnNewButton_2_2);
		
		JButton btnNewButton_2_3 = new JButton("Prikaz korisnika");
		btnNewButton_2_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				prikaz_korisnika prikaz_korisnika=new prikaz_korisnika();
				prikaz_korisnika.setVisible(true);
			}
		});
		btnNewButton_2_3.setBounds(189, 208, 146, 60);
		...
		JButton btn_prijava = new JButton("Prijava korisnika");
		...
		btn_prijava.setBounds(21, 304, 146, 60);
		frmPoetna.getContentPane().add(btn_prijava);
	}
