...
public class admin_page extends JFrame {
    ...
    private JButton btnSpremi;  // deklariramo globalno da možemo kontrolirati vidljivost
    ...
    private void prikaziBiljke() {
        model = new DefaultTableModel(new Object[]{"Naziv", "Opis", "Vrsta"}, 0);
        table.setModel(model);
    ...
    private void spremiPromjeneOdobravanja() {
        ...
        try (Connection conn = spojiNaBazu()) {
            ...
            PreparedStatement psUpdate = conn.prepareStatement(
                    "UPDATE Korisnik SET admin = ? WHERE korisnicko_ime = ?");
            ...
            for (int i = 0; i < model.getRowCount(); i++) {
                ...
                psUpdate.setInt(1, odobreno ? 1 : 0);
                psUpdate.setString(2, korisnickoIme);
                psUpdate.addBatch();
